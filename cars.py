...
cap = cv2.VideoCapture(r'F:\new wheel\Car-wheel-velocity-detection-OpenCV-master\cars_passing_input.mp4')
wheel_count=[]
...
while(cap.isOpened()):
    ...
    if ret:
        ...
        def ssd(img1):
            try:
                tire1=cv2.imread(r"F:\new wheel\Car-wheel-velocity-detection-OpenCV-master\wheel977.png",0)
